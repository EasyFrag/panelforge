...
- Après le point de restauration `stable-avant-masque-2026-09-06`, reprendre la conception du masque après génération dans Modifier avec KREA2, puis son implémentation lorsqu'elle est demandée ; s'appuyer sur le comparateur/frise existants. Priorité à l'aperçu direct et à la conservation des deux originaux, avec limites de raccord explicites.

- L'utilisateur lance ses tests, redémarre/recharge quand ses générations le permettent, puis valide la file Assisted : ajouter plusieurs essais avec différents réglages, annuler un essai en attente, ouvrir un autre atelier, vérifier reprise et absence de doublon. Les deux anciens essais de « Horror décalé » restent préparés et disposent d'un bouton d'ajout volontaire ; ne pas les lancer à sa place. Aucun changement du masque ni du filtre Sick Ollie.
