...
- **Contrainte du futur patch REF2V** : H3 figé (consignes, schéma, compilation, parcours et rendu). Corriger REF2V et, si nécessaire, spécialiser ses consignes/champs de références/assemblage dans une version REF2V explicite. Conserver le socle commun existant sans effet de bord H3, deux appels, toutes les références dans leur ordre, grammaire REF2V et isolation des familles. Ne pas lancer le patch sur la seule demande d'alignement.

- **Suite proposée à l'audit REF2V, seulement sur demande** : corriger en priorité le routage Classique Mise en scène et la conservation des références, prévoir la reprise du projet déjà mal classé ; couvrir cette frontière dans les tests. Puis rendre lisibles les versions réellement reprises et adopter explicitement les évolutions H3 dans REF2V de la même famille. Préserver les rôles d'images, les anciens projets et l'isolation Classique/Combat/Sensuel. P1 I2V 1.1 n'est pas encore implémenté sur H3 ; P2 analyse adaptative et presets EROS/BUNNY restent inchangés.
