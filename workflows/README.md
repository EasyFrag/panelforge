...
La recette Video Lab MiniMax H3 Ref2V `0.2.0` accepte strictement une à trois
références ordonnées dans son snapshot ; l’atelier Ref2V intégré prolonge le
même connecteur variadique jusqu’à neuf images. Elle génère d’abord à 0,2 MP,
upscale le latent vidéo vers la cible choisie, recombine l’audio puis applique
une seconde passe fixe de trois steps. PanelForge compile le prompt, le ratio,
les mégapixels finaux, la durée, les steps principaux et la seed, puis retire
les slots d’images inutilisés avant soumission.
