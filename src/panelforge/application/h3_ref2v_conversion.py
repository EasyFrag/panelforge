...
def compile_conversion(raw: str, source_prompt: str, roles: tuple[str, ...], *, combat_sequence: bool = False, combat_version: str | None = None) -> str:
...
class H3Ref2VConversionService:
    ...
    def prepare(self, source_id: str, *, request_id: str, prompt: str, model_id: str,
        ...
        project = H3RenderProject(target_id, source.source_session_id, f"adaptation:{request_id}", model_id,
            ...
            combat_settings=source.combat_settings, adaptation=adaptation)
        with self._lock:
            try:
