...
- comparer `minimax.h3.ref2v.direct@0.3.1` à son témoin verrouillé `0.3.0` avec les mêmes références et intentions ; mesurer rejets de forme, fidélité aux rôles, qualité des arbitrages, continuité, rythme, clipping et concision du prompt final ;
