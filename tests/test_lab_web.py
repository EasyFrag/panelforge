...
class LabWebTest(unittest.TestCase):
    ...
    def test_serves_page_and_curated_recipe_spec(self):
        ...
        self.assertIn("/static/ref2v-direct.js?v=20260812.3", page.text)
        ...
        self.assertIn('const preferredCookbookVersion = "0.3.2"', direct_script.text)
