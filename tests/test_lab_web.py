...
class LabWebTest(unittest.TestCase):
    ...
    def test_serves_page_and_curated_recipe_spec(self):
        ...
        self.assertIn("/static/lab.css?v=20260909.2", page.text)
        ...
        self.assertIn("/static/lab-core.js?v=20260909.1", page.text)
    ...
    def test_serves_the_h3_base_workspace_with_optional_boundary_frames(self):
        ...
        self.assertIn('/static/h3-render-lab.js?v=20260909.2', page.text)
        ...
        self.assertIn('/static/i2v-direct.js?v=20260908.1', page.text)
        ...
        self.assertIn('const preferredCookbookKey = "minimax.h3.fl2va.direct.guided@1.1.0"', script.text)
