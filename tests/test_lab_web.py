...
class LabWebTest(unittest.TestCase):
    ...
    def test_serves_page_and_curated_recipe_spec(self):
        ...
        self.assertIn("/static/ref2v-direct.js?v=20260812.1", page.text)
        ...
        self.assertIn('const preferredCookbookVersion = "0.3.1"', direct_script.text)
        ...
        self.assertIn("/static/prompt-lab.js?v=20260811.4", page.text)
