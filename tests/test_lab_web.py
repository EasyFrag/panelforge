...
class LabWebTest(unittest.TestCase):
    ...
    def test_serves_the_h3_base_workspace_with_optional_boundary_frames(self):
        ...
        self.assertIn('/static/h3-render-lab.js?v=20260915.1', page.text)
        ...
        self.assertNotIn('/static/production-lab.js?v=', page.text)
        self.assertNotIn('/static/production-v2-lab.js?v=', page.text)
