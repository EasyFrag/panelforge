...
class LabWebTest(unittest.TestCase):
    ...
    def test_serves_page_and_curated_recipe_spec(self):
        ...
        self.assertIn('const preferredCookbookValue = "minimax.h3.ref2v.classic.cinematic.planned@1.0.0"', direct_script.text)
        ...
        self.assertIn("/static/lab-core.js?v=20260911.5", page.text)
    ...
    def test_serves_the_h3_base_workspace_with_optional_boundary_frames(self):
        ...
        self.assertIn('/static/h3-render-lab.js?v=20260914.2', page.text)
        ...
        self.assertIn('/static/production-lab.js?v=20260907.8', page.text)
        ...
        self.assertIn('const preferredCookbookKey = "minimax.h3.fl2va.classic.cinematic.planned@1.0.0"', script.text)
