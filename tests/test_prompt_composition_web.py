...
class PromptCompositionWebTest(unittest.TestCase):
    ...
    def test_serves_the_modular_prompt_composition_frontend(self):
        ...
        h3_script = self.client.get("/static/i2v-direct.js")
        ...
        self.assertIn('i2v-direct.js?v=20260824.2', page.text)
        ...
        self.assertIn("minimax.h3.fl2va.direct.multishot", h3_script.text)
        self.assertIn("Multi-plan structuré · 2 à 4 plans (${cookbook.version})", h3_script.text)
        self.assertIn('data-lab-view="i2v-direct"', h3_script.text)
        ...
        self.assertIn('ref2v-direct.js?v=20260824.1', page.text)
        ...
        self.assertIn('cookbook.version === "0.2.0"', direct_script.text)
        ...
        self.assertIn("function renderMultishotSummary()", direct_script.text)
