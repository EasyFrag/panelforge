...
class CombatPreparationTest(unittest.TestCase):
    ...
    def test_legacy_session_schema_nine_reads_as_classic(self):
        with tempfile.TemporaryDirectory() as directory:
            ...
            data = json.loads(path.read_text(encoding="utf-8")); data["schema_version"] = 9; data.pop("preparation"); data.pop("combat_settings"); data.pop("cinematic_settings"); data.pop("sensual_settings")
